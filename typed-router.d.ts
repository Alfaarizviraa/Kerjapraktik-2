...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'domain-price': RouteRecordInfo<'domain-price', '/domain-price', Record<never, never>, Record<never, never>>,
    ...
    'hosting-price': RouteRecordInfo<'hosting-price', '/hosting-price', Record<never, never>, Record<never, never>>,
